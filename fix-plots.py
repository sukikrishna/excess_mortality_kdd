...
PLOT_CONFIG = {
    ...
    'show_prediction_intervals': False,  # Toggle prediction intervals on/off
...
PLOTS_DIR = 'publication_ready_plots'
...
def create_publication_ready_comparison_plot(sarima_data, model_data, model_name, horizon_label,
    ...
    """Create clean, publication-ready comparison plot"""
    ...
    ax.fill_between(all_dates, model_all_ci_lower, model_all_ci_upper, 
                    ...
                    label=f'{MODEL_NAMES[model_name]} 95% CI')
    ...
    # Simplified legend - positioned to avoid overlap
